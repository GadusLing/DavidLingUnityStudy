...
public class UnityEngine_DebugWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("developerConsoleEnabled", get_developerConsoleEnabled, set_developerConsoleEnabled);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_developerConsoleEnabled(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, UnityEngine.Debug.developerConsoleEnabled);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_developerConsoleEnabled(IntPtr L)
	{
		try
		{
			bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
			UnityEngine.Debug.developerConsoleEnabled = arg0;
			return 0;
		}
		catch (Exception e)
		{
