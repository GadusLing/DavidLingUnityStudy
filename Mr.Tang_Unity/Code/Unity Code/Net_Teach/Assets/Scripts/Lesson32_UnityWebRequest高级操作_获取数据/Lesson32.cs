...
public class Lesson32 : MonoBehaviour
{
    ...
    {
        UnityWebRequest req = new UnityWebRequest("http://192.168.1.2:8081/Http_Server/UnityWebRequest.png", 
    ...
    {
        UnityWebRequest req = new UnityWebRequest("http://192.168.1.2:8081/Http_Server/model", UnityWebRequest.kHttpVerbGET);
    ...
    {
        UnityWebRequest req = UnityWebRequestMultimedia.GetAudioClip("http://192.168.1.2:8081/Http_Server/音效名.mp3", 
                                                                      AudioType.MPEG);
        yield return req.SendWebRequest();
    ...
    {
        UnityWebRequest req = new UnityWebRequest("http://192.168.1.2:8081/Http_Server/21.服务端.mp4", UnityWebRequest.kHttpVerbGET);
