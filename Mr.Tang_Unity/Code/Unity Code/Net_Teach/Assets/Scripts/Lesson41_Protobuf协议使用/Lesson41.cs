...
public class Lesson41 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        using (FileStream fs = File.Create(Application.persistentDataPath + "/TestMsg.Ling"))
        {
            msg.WriteTo(fs);
        }
        #endregion
        ...
        //2.文件流FileStream对象
        using (FileStream fs = File.OpenRead(Application.persistentDataPath + "/TestMsg.Ling"))
        {
            TestMsg msg2 = null;
