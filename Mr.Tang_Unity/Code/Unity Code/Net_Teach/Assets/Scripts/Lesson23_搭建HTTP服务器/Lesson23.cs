...
public class Lesson23 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //比如我们可以下载在互联网上可被下载的图片
        #endregion

        #region 总结
        //在实际商业项目开发当中
        //HTTP 资源服务器 可以自己写 也可以用别人做好的软件
        //HTTP 网站服务器 或 游戏服务器 需要自己根据需求进行实现
        //这些工作一般都是由后端或者运维程序员来进行制作
        //我们主要做了解
        //我们之后主要靠自学了解HTTP相关的知识点

        //在游戏开发时，我们更多时候需要的是HTTP内的资源服务器
        //除非你要做独立游戏服务端，那么你就可以以HTTP协议为基础来开发服务端应用程序
        //我们只需要学习前端如何进行HTTP通信的相关知识即可
        #endregion
    }
